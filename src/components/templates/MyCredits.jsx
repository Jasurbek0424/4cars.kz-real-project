    ...
    return (
        <>
            <div className='flex flex-wrap justify-center gap-4 mt-4'>
                <img className='max-w-[400px] w-full shadow-md' src={Card1} alt='' />
                <img className='max-w-[400px] w-full shadow-md' src={Card2} alt='' />
                <img className='max-w-[400px] w-full shadow-md' src={Card3} alt='' />
                <img className='max-w-[400px] w-full shadow-md' src={Card4} alt='' />
            </div>
