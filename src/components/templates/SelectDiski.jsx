...
export default function FullWidthTabs() {
    ...
    return (
        ...
        <Box sx={{ bgcolor: 'background.paper', width: 610 }} className=''>
                    ...
                    <div className="h-64 relative">
                        ...
                        <div className='flex flex-col gap-5'>
                            ...
                            <div className='flex gap-5 cursor-pointer'>
                                ...
                                <label className='text-white' htmlFor='check' >Только в наличии</label>
                            </div>
                            ...
                            <img
                                src={Diska}
                                alt='Shina'
                                className='absolute w-48 -bottom-2 -right-1'
                            />
                        </div>
                    </div>
                </TabPanel>
